package org.openea.eapboot.generator;

import org.openea.eapboot.generator.bean.Entity;
...
public class EapbootGenerator {
     ...
     * (文件自动生成至该包下)
     */
    private static final String entityPackage = "org.openea.eapboot.modules.your.entity";

    /**
     * dao对应包
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "org.openea.eapboot.modules.your.dao";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String servicePackage = "org.openea.eapboot.modules.your.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String serviceImplPackage = "org.openea.eapboot.modules.your.serviceimpl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String controllerPackage = "org.openea.eapboot.modules.your.controller";
    ...
    public static void main(String[] args) throws Exception {
        ...
        //模板路径
        String root = System.getProperty("user.dir")+"/src/main/java/org/openea/eapboot/generator/template";
